...
namespace AeroRide.API.Helpers.Templates
{
    ...
    {
        /// <summary>
        /// Genera el HTML para el correo de notificación de piernas vacías.
        /// </summary>
        public static string Build(
            string userName,
            string country,
            string legsListItemsHtml,   // aquí metemos los <li>...</li>
            string? ctaUrl = null       // link opcional hacia la app / web
        )
        {
                ...
                <table width=""100%"" cellpadding=""0"" cellspacing=""0"" border=""0"" style=""max-width:600px; background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 10px 25px rgba(15,23,42,0.08);"">
                    <tr>
                        <td style=""background:linear-gradient(135deg,#0f172a,#1d4ed8); padding:20px 24px; color:#e5e7eb;"">
                            ...
                            <p style=""margin:6px 0 0 0; font-size:13px; color:#cbd5f5;"">
                                Oportunidades flexibles de vuelo privado, sujetas a disponibilidad.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style=""padding:20px 24px 8px 24px; font-size:14px; color:#111827;"">
                            ...
                            <p style=""margin:0 0 8px 0; font-weight:600; font-size:13px; text-transform:uppercase; color:#6b7280;"">
                                Rutas disponibles:
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style=""padding:20px 24px 16px 24px; font-size:11px; color:#9ca3af; border-top:1px solid #e5e7eb;"">
                            <p style=""margin:0 0 4px 0;"">
                                Estás recibiendo este correo porque tienes una cuenta activa en <strong>AeroRide</strong> 
                                y te encuentras registrado en {System.Net.WebUtility.HtmlEncode(country)}.
                            </p>
                            <p style=""margin:0;"">
                                Si no deseas recibir notificaciones de piernas vacías, por favor contacta al soporte de AeroRide.
                            </p>
                        </td>
                    </tr>
                </table>
