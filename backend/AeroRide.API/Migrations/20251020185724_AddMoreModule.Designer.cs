...
namespace AeroRide.API.Migrations
{
    ...
    [Migration("20251020185724_AddMoreModule")]
    partial class AddMoreModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AeroRide.API.Models.Domain.FlightPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AeroRide.API.Models.Domain.FlightPlan", b =>
                {
                    b.HasOne("AeroRide.API.Models.Domain.Flight", "Flight")
                        .WithOne("FlightPlan")
                        .HasForeignKey("AeroRide.API.Models.Domain.FlightPlan", "FlightId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
