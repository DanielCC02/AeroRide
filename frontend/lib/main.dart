...
void main() {
  // DevicePreview solo cuando NO sea Android real
  final bool enablePreview =
      kIsWeb ||
      (!kReleaseMode && defaultTargetPlatform == TargetPlatform.windows);
...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> _checkLoginStatus() async {
    ...
    try {
      ...
      if (kDebugMode) debugPrint('⚠️ Error al verificar token/perfil: $e');
      await TokenStorage.clearTokens();
      if (mounted) setState(() => _defaultScreen = const WelcomeScreen());
    }
  }
